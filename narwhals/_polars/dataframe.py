...
class PolarsDataFrame:
    ...
    @overload
    def __getitem__(self, item: str) -> PolarsSeries: ...

    @overload
    def __getitem__(self, item: slice) -> PolarsDataFrame: ...

    def __getitem__(self, item: str | slice) -> PolarsSeries | PolarsDataFrame:
    ...
    def filter(
        self,
        *predicates: IntoPolarsExpr,
    ) -> Self:
        from narwhals._polars.namespace import PolarsNamespace

        plx = PolarsNamespace(self._backend_version)
    ...
    # --- actions ---
    def group_by(self, *keys: str | Iterable[str]) -> PolarsGroupBy:
        from narwhals._polars.group_by import PolarsGroupBy
    ...
    def to_numpy(self) -> Any:
        from narwhals._polars.series import PANDAS_TO_NUMPY_DTYPE_MISSING
    ...
    # --- descriptive ---
    def is_duplicated(self: Self) -> PolarsSeries:
        from narwhals._polars.series import PolarsSeries
    ...
    def is_unique(self: Self) -> PolarsSeries:
        from narwhals._polars.series import PolarsSeries
    ...
    def null_count(self: Self) -> PolarsDataFrame:
        return PolarsDataFrame(
