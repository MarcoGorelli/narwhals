...
class PolarsSeries:
    ...
    def __len__(self) -> int:
        return self._native_series.len()
    ...
    def item(self: Self, index: int | None = None) -> Any:
        return self._native_series.item()
    ...
    def filter(self, other: Any) -> PolarsSeries:
        ser = self._native_series
    ...
    def __pow__(self, other: Any) -> PolarsSeries:
        ser = self._native_series
        other = validate_column_comparand(self._native_series.index, other)
        return self._from_native_series(self._rename(ser.__pow__(other), ser.name))

    def __rpow__(self, other: Any) -> PolarsSeries:  # pragma: no cover
        ser = self._native_series
        other = validate_column_comparand(self._native_series.index, other)
    ...
    def __rmod__(self, other: Any) -> PolarsSeries:  # pragma: no cover
        ser = self._native_series
        other = validate_column_comparand(self._native_series.index, other)
    ...
    def __invert__(self: PolarsSeries) -> PolarsSeries:
        ser = self._native_series
    ...
    def fill_null(self, value: Any) -> PolarsSeries:
        ser = self._native_series
    ...
    def diff(self) -> PolarsSeries:
        return self._from_native_series(self._native_series.diff())

    def shift(self, n: int) -> PolarsSeries:
    ...
    def zip_with(self: Self, mask: Any, other: Any) -> PolarsSeries:
        ser = self._native_series
...
class PolarsSeriesStringNamespace:
    ...
    def starts_with(self, prefix: str) -> PolarsSeries:
        return self._pandas_series._from_native_series(
            self._pandas_series._native_series.str.startswith(prefix),
        )

    def ends_with(self, suffix: str) -> PolarsSeries:
        return self._pandas_series._from_native_series(
            self._pandas_series._native_series.str.endswith(suffix),
        )

    def contains(self, pattern: str, *, literal: bool = False) -> PolarsSeries:
        return self._pandas_series._from_native_series(
    ...
    def slice(self, offset: int, length: int | None = None) -> PolarsSeries:
        stop = offset + length if length else None
        return self._pandas_series._from_native_series(
            self._pandas_series._native_series.str.slice(start=offset, stop=stop),
        )

    def to_datetime(self, format: str | None = None) -> PolarsSeries:  # noqa: A002
        return self._pandas_series._from_native_series(
    ...
    def to_uppercase(self) -> PolarsSeries:
        return self._pandas_series._from_native_series(
            self._pandas_series._native_series.str.upper(),
        )

    def to_lowercase(self) -> PolarsSeries:
        return self._pandas_series._from_native_series(
...
class PolarsSeriesDateTimeNamespace:
    ...
    def total_minutes(self) -> PolarsSeries:
    ...
    def total_seconds(self) -> PolarsSeries:
        s = self._pandas_series._native_series.dt.total_seconds()
        s_sign = (
            2 * (s > 0).astype(int_dtype_mapper(s.dtype)) - 1
        )  # this calculates the sign of each series element
    ...
    def total_milliseconds(self) -> PolarsSeries:
    ...
    def total_microseconds(self) -> PolarsSeries:
    ...
    def total_nanoseconds(self) -> PolarsSeries:
    ...
    def to_string(self, format: str) -> PolarsSeries:  # noqa: A002
